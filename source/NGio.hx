...
/**
 * NOTE: comment out the newgrounds lib from project.xml to ingore newgrounds.io
 * API-less NGIO is at the bottom of the file, be sure to add methods there when
 * you add them to the first class
 */
#if newgrounds
import flixel.FlxG;
...
/**
 * A bunch of empty functions so people can play without newgrounds.io
 */
class NGio
{
	public static var isLoggedIn:Bool = false;
