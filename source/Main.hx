...
class Main extends Sprite
{
  ...
  function setupGame():Void
  {
    ...
    var game:FlxGame = new funkin.FunkinGame(gameWidth, gameHeight, initialState, framerate, framerate, skipSplash, (FlxG.stage.window.fullscreen || Preferences.autoFullscreen));
