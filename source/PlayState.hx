		...
		for (i in 0...4)
		{
			...
			switch (curStage)
			{
				case 'school' | 'schoolEvil':
					...
					if (Note.arrowName != "purple")
						babyArrow.animation.add(Note.arrowName, [Note.arrowPixelNum]);
					else
						babyArrow.animation.add(Note.arrowName + "l", [Note.arrowPixelNum]);

					babyArrow.setGraphicSize(Std.int(babyArrow.width * daPixelZoom));
					babyArrow.updateHitbox();
					babyArrow.antialiasing = false;

					babyArrow.animation.add('static', [0 + i]);
