...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch _saveconrtol.data.boxPositions[0] {
			case 1:
				this.remove(_pad);
				_pad = null;
			...
			case 2:
				this.remove(_pad);
				_pad = null;
				_pad = new FlxVirtualPad(ALTER_FULL, NONE);
				_pad.alpha = 0.75;
				this.add(_pad);
				_pad.cameras = [camHUD];
			default:
	...
	private function keyShit():Void
	{
		...
		var upR = _pad.buttonUp.justReleased;
		var rightR = _pad.buttonRight.justReleased;
		var downR = _pad.buttonDown.justReleased;
		var leftR = _pad.buttonLeft.justReleased;
