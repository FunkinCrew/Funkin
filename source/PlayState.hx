...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		scoreTxt.setFormat("assets/fonts/vcr.ttf", 16, FlxColor.WHITE, RIGHT, OUTLINE, FlxColor.BLACK);
		scoreTxt.scrollFactor.set();
		add(scoreTxt);

		curSongText = new FlxText(healthBarBG.x + healthBarBG.width - 490, healthBarBG.y + 30, 0, "", 20);
		curSongText.setFormat("assets/fonts/vcr.ttf", 16, FlxColor.WHITE, LEFT, OUTLINE, FlxColor.BLACK);
