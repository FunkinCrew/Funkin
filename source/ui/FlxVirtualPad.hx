...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	public function new(?DPad:FlxDPadMode, ?Action:FlxActionMode)
	{
		...
		{
			case UP_DOWN:
				dPad.add(add(buttonUp = createButton(3 * 3, FlxG.height - 96 * 3, 44 * 3, 45 * 3, "up")));
				dPad.add(add(buttonDown = createButton(3 * 3, FlxG.height - 48 * 3, 44 * 3, 45 * 3, "down")));
			case LEFT_RIGHT:
				dPad.add(add(buttonLeft = createButton(0, FlxG.height - 48 * 3, 44 * 3, 45 * 3, "left")));
				dPad.add(add(buttonRight = createButton(48 * 3, FlxG.height - 48 * 3, 44 * 3, 45 * 3, "right")));
			case UP_LEFT_RIGHT:
			...
			case FULL:
				dPad.add(add(buttonUp = createButton(42 * 3, FlxG.height - 116 * 3, 44 * 3, 45 * 3, "up")));
				dPad.add(add(buttonLeft = createButton(0, FlxG.height - 81 * 3, 44 * 3, 45 * 3, "left")));
				dPad.add(add(buttonRight = createButton(84 * 3, FlxG.height - 81 * 3, 44 * 3, 45 * 3, "right")));
				dPad.add(add(buttonDown = createButton(42 * 3, FlxG.height - 45 * 3, 44 * 3, 45 * 3, "down")));
			case LEFT_FULL:
				dPad.add(add(buttonUp = createButton(42 * 3, FlxG.height- 66 - 116 * 3, 44 * 3, 45 * 3, "up")));
				dPad.add(add(buttonLeft = createButton(0, FlxG.height - 66 - 81 * 3, 44 * 3, 45 * 3, "left")));
				dPad.add(add(buttonRight = createButton(84 * 3, FlxG.height - 66 - 81 * 3, 44 * 3, 45 * 3, "right")));
				dPad.add(add(buttonDown = createButton(42 * 3, FlxG.height - 66 - 45 * 3, 44 * 3, 45 * 3, "down")));
			...
			case SPLIT:
				dPad.add(add(buttonLeft = createButton(0, FlxG.height - 116 * 3, 44 * 3, 45 * 3, "left")));
				dPad.add(add(buttonRight = createButton(48 * 3, FlxG.height - 116 * 3, 44 * 3, 45 * 3, "right")));
				dPad.add(add(buttonUp = createButton(FlxG.width - 44 * 3, FlxG.height - 116 * 3 - 44, 44 * 3, 45 * 3, "up")));
		...
		{
			case A:
				actions.add(add(buttonA = createButton(FlxG.width - 48 * 3, FlxG.height - 48 * 3, 44 * 3, 45 * 3, "a")));
			case B:
				actions.add(add(buttonB = createButton(FlxG.width - 45 * 3, 0, 44 * 3, 45 * 3, "b")));
				buttonB.scale.x = 0.75;
				buttonB.scale.y = 0.75;
			case A_B:
				actions.add(add(buttonA = createButton(FlxG.width - 48 * 3, FlxG.height - 48 * 3, 44 * 3, 45 * 3, "a")));
				actions.add(add(buttonB = createButton(FlxG.width - 96 * 3, FlxG.height - 48 * 3, 44 * 3, 45 * 3, "b")));
			case A_B_C:
			...
			case A_B_X_Y:
				actions.add(add(buttonY = createButton(FlxG.width - 89, FlxG.height - 85, 44, 45, "y")));
				actions.add(add(buttonX = createButton(FlxG.width - 48, FlxG.height - 85, 44, 45, "x")));
				actions.add(add(buttonB = createButton(FlxG.width - 96, FlxG.height - 45, 44, 45, "b")));
				actions.add(add(buttonA = createButton(FlxG.width - 48, FlxG.height - 45, 44, 45, "a")));
			case NONE: // do nothing
		}
	}
