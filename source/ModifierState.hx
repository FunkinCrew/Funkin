...
class ModifierState extends MusicBeatState
{
	...
	override function create()
	{
		...
		modifiers = [{name: "Perfect Mode", value: false}, {name:"FC Mode", value: false}, {name: "Practice Mode", value: false}, {name: "Health Gain Up", value: false}, {name: "Health Gain Down", value: false}, {name: "Health Loss Up", value: false}, {name: "Health Loss Down", value: false},{name: "Play", value: false}];
