...
class NewCharacterCard extends BackingCard
{
  ...
  override public function onCreate(event:ScriptEvent):Void
  {
    ...
    var bitmap = BitmapUtil.scalePartByWidth(
      Assets.getBitmapData(Paths.image('ui/freeplay/styles/unlock/backing-card/dark-back'), true, false, false),
    ...
    add(newUnlock3);
    var bitmap = BitmapUtil.scalePartByWidth(
      Assets.getBitmapData(Paths.image('ui/freeplay/styles/unlock/backing-card/multiply-bar'), true, false, false),
      FreeplayState.CUTOUT_WIDTH
    );
    ...
    add(lightLayer);
    var bitmap = BitmapUtil.scalePartByWidth(
      Assets.getBitmapData(Paths.image('ui/freeplay/styles/unlock/backing-card/red'), true, false, false),
      FreeplayState.CUTOUT_WIDTH
    );
    ...
    var bitmap = BitmapUtil.scalePartByWidth(
      Assets.getBitmapData(Paths.image('ui/freeplay/styles/unlock/backing-card/yellow-bg'), true, false, false),
      FreeplayState.CUTOUT_WIDTH
    );
