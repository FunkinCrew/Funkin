...
class NewCharacterCard extends BackingCard
{
  ...
  public override function init():Void
  {
    ...
    var bitmap = BitmapUtil.scalePartByWidth(Assets.getBitmapData(Paths.image('freeplay/backingCards/newCharacter/darkback')),
    ...
    var bitmap = BitmapUtil.scalePartByWidth(Assets.getBitmapData(Paths.image('freeplay/backingCards/newCharacter/multiplyBar')),
      FullScreenScaleMode.cutoutSize.x);
    multiplyBar = new FlxSprite(-10, 440).loadGraphic(bitmap);
    multiplyBar.blend = BlendMode.MULTIPLY;
    add(multiplyBar);

    lightLayer = new FlxSprite((FullScreenScaleMode.cutoutSize.x * 0.45) + -360,
      230).loadGraphic(Paths.image('freeplay/backingCards/newCharacter/orange gradient'));
    lightLayer.blend = BlendMode.ADD;
    add(lightLayer);

    var bitmap = BitmapUtil.scalePartByWidth(Assets.getBitmapData(Paths.image('freeplay/backingCards/newCharacter/red')), FullScreenScaleMode.cutoutSize.x);
    ...
    lightLayer2 = new FlxSprite((FullScreenScaleMode.cutoutSize.x * 0.45) + -360,
      230).loadGraphic(Paths.image('freeplay/backingCards/newCharacter/orange gradient'));
    ...
    lightLayer3 = new FlxSprite((FullScreenScaleMode.cutoutSize.x * 0.45) + -360,
