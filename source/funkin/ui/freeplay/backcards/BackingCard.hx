...
class BackingCard extends FlxSpriteGroup implements IBPMSyncedScriptedClass implements IStateChangingScriptedClass implements IFreeplayScriptedClass
{
  ...
  public function new(currentCharacter:String)
  {
    ...
    var bitmap = BitmapUtil.scalePartByWidth(Assets.getBitmapData(Paths.image('freeplay/cardGlow'), false, false, false), FreeplayState.CUTOUT_WIDTH);
    ...
    var bitmap = BitmapUtil.scalePartByWidth(Assets.getBitmapData(Paths.image('freeplay/pinkBack'), false, false, false), FreeplayState.CUTOUT_WIDTH);
