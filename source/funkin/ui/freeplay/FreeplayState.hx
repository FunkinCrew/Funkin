...
class FreeplayState extends MusicBeatSubState
{
  ...
  /**
   * For scaling scroll values generated by the non-standard mouse scrolling devices (ex. touchpads)
   */
  public static final TOUCHPAD_SENSITIVITY:Float = 0.9;
  ...
  function handleMouseSelectionScroll(elapsed:Float):Void
  {
    ...
    {
      var delta = FlxMath.bound(FlxG.mouse.deltaWheel.y, -1, 1) * framerateMultiplier;
