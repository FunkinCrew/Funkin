...
private class TimelineLayerPanelBuilder extends CompositeBuilder
{
  ...
  override public function create():Void
  {
    ...
    _panel.btnAddLayer.resource = "assets/ui/editors/camera-editor/add_layer.png";
    ...
    _panel.btnRemoveLayer.resource = "assets/ui/editors/camera-editor/delete_layer.png";
