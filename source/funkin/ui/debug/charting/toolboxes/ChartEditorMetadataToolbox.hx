...
class ChartEditorMetadataToolbox extends ChartEditorBaseToolbox
{
  ...
  function initialize():Void
  {
    ...
    inputSongId.onChange = (event:UIEvent) -> {
    ...
    createTimeChange.onClick = (_:UIEvent) -> {
    ...
    removeTimeChange.onClick = (_:UIEvent) -> {
