...
import funkin.data.theme.EditorThemeRegistry;
import flixel.util.FlxColor;

/**
 * A class representing the data for an editor theme as displayed in the game editors.
 */
class EditorTheme implements IRegistryEntry<EditorThemeData>
{
  /**
   ...
   */
  public final _data:EditorThemeData;
  ...
  static function _fetchData(id:String):Null<EditorThemeData>
  {
    return EditorThemeRegistry.instance.parseEntryDataWithMigration(id, EditorThemeRegistry.instance.fetchEntryVersion(id));
  }
}
