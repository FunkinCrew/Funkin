...
class Assets
{
   ...
   */
  public static function getBitmapData(path:String, useCache:Bool = true, ?allowCompress:Bool = true, ?allowUnCompress:Bool = true):openfl.display.BitmapData
  {
    return openfl.utils.Assets.getBitmapData(path, useCache, allowCompress, allowUnCompress);
  }
