...
class RegistryMacro
{
  ...
  public static macro function buildRegistry():ComplexType
  {
    ...
    {
      case TInst(_, [p1, p2, p3]): [p1, p2, p3];
    ...
    var dataFilePath:String = switch (params[2])
    {
      case TInst(_.get() => {kind: KExpr(macro $v{(s : String)})}, _): s;
      default: throw 'Should not happen';
    }

    var registry:ComplexType = buildRegistryImpl(name, pack, params, entryType, dataType, dataFilePath);
   ...
   */
  static function buildRegistryImpl(name:String, pack:Array<String>, params:Array<Type>, entryType:ClassType, dataType:Dynamic, dataFilePath:String):ComplexType
  {
    ...
    registry.pack = pack;
    registry.fields = registry.fields.concat(buildRegistryMethods(entryType, dataType, dataFilePath));
