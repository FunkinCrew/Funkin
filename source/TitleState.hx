...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		if (FlxG.save.data.watermarks) {
			...
			logoBl.frames = Paths.getSparrowAtlas('WBEngineBumpin');
		} else {
			...
			new FlxTimer().start(2, function(tmr:FlxTimer)
				{
					...
					var http = new haxe.Http("https://raw.githubusercontent.com/GEDON6676/WB-Engine/master/.current");
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 5:
				if(FlxG.save.data.watermarks)
					createCoolText(['WB Engine', 'by']);
				else
					createCoolText(['In association', 'with']);
			case 7:
				if(FlxG.save.data.watermarks)
					addMoreText('GEDON6676');
				else {
