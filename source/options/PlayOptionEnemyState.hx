...
class PlayOptionEnemyState extends MusicBeatState
{
	...
	var optionShit:Array<String> = [
		'Boyfriend', 'Dad', 'Garcello', 'Whitty', 'TrickyMask',"Hex-Virus"
		// 'Parents-christmas', 'Senpai', 'Senpai-angry',
		//  'Spririt', 'Garcello', 'Garcellotired', 'Garcellodead',
		//   "Garcelloghosty", 'Hex', 'Hex-virus', 'Whitty', 'Ballistic',
		//   'Sarvante', 'Worship', 'Zavodila', 'Gospel', 'Casanova',
		//   'TrickyMask', 'Tricky'
	];
                        ...
                        menuItems.forEach(function(spr:FlxSprite)
                        {
                            ...
                            else
                            {
                                FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
                                {
									...
									PlayOptionState._song.player2 = daChoice.toLowerCase();
									FlxG.switchState(new PlayOptionState());
