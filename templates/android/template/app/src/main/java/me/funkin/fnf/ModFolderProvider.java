...
public class ModFolderProvider extends DocumentsProvider
{
    private static final String TAG = "ModFolderProvider";
    ...
    public Cursor queryChildDocuments(String parentDocumentId, String[] projection, String sortOrder) throws FileNotFoundException
    {
        ...
        final File parent = getFileFromDocumentID(parentDocumentId);
